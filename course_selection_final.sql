...
(1311, '班級活動', 0, '資訊系', '二下乙班', 60, 2),
(1312, '系統程式', 3, '資訊系', '二下乙班', 60, 2),
(1313, '資料庫系統', 3, '資訊系', '二下乙班', 60, 2),
(1314, '機率與統計', 3, '資訊系', '二下乙班', 60, 2),
(1323, '互連網路', 3, '資訊系', '選修', 60, 1),
(1324, 'Web程式設計', 3, '資訊系', '選修', 60, 0),
(1326, '系統分析與設計', 3, '資訊系', '選修', 60, 1),
(1328, '多媒體系統', 3, '資訊系', '選修', 60, 1),
(1334, 'UNIX應用與實務', 2, '資訊系', '選修	', 60, 1),
...
(2953, '認識休閒遊程與永續發展', 2, '通識中心', '選修', 60, 0),
(2959, '人生哲學', 2, '通識中心', '選修', 60, 1),
(2960, '人生哲學', 2, '通識中心', '選修', 1, 0),
(3044, '智慧財產之保護與實務', 2, '通識中心', '選修', 60, 1),
(3092, '網際網路資訊的甄別與運用', 2, '通識中心', '選修', 60, 1),
(3116, 'SDGS產品/服務系統的創新與實作', 2, '通識中心', '選修', 60, 1),
(3133, '奈米科技與生活', 2, '通識中心', '選修', 60, 1);
